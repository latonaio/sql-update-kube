...
var DataPlatformDeliveryDocumentItemDatumTableColumns = struct {
	...
	ProductWeightUnit:                             "data_platform_delivery_document_item_data.ProductWeightUnit",
	ProductNetWeight:                              "data_platform_delivery_document_item_data.ProductNetWeight",
...
var DataPlatformDeliveryDocumentItemDatumWhere = struct {
	...
	ProductWeightUnit:                             whereHelpernull_String{field: "`data_platform_delivery_document_item_data`.`ProductWeightUnit`"},
	ProductNetWeight:                              whereHelpernull_Float32{field: "`data_platform_delivery_document_item_data`.`ProductNetWeight`"},
