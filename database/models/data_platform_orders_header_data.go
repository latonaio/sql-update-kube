...
var DataPlatformOrdersHeaderDatumTableColumns = struct {
	...
	OrderStatus:                      "data_platform_orders_header_data.OrderStatus",
	...
	ProductionOrderItem:              "data_platform_orders_header_data.ProductionOrderItem",
	Operations:                       "data_platform_orders_header_data.Operations",
	OperationsItem:                   "data_platform_orders_header_data.OperationsItem",
	OperationID:                      "data_platform_orders_header_data.OperationID",
	...
	ExternalReferenceDocument:        "data_platform_orders_header_data.ExternalReferenceDocument",
	CertificateAuthorityChain:        "data_platform_orders_header_data.CertificateAuthorityChain",
	UsageControlChain:                "data_platform_orders_header_data.UsageControlChain",
...
var DataPlatformOrdersHeaderDatumWhere = struct {
	...
	OrderStatus:                      whereHelperstring{field: "`data_platform_orders_header_data`.`OrderStatus`"},
	...
	ProductionOrderItem:              whereHelpernull_Int{field: "`data_platform_orders_header_data`.`ProductionOrderItem`"},
	Operations:                       whereHelpernull_Int{field: "`data_platform_orders_header_data`.`Operations`"},
	OperationsItem:                   whereHelpernull_Int{field: "`data_platform_orders_header_data`.`OperationsItem`"},
	OperationID:                      whereHelpernull_Int{field: "`data_platform_orders_header_data`.`OperationID`"},
	...
	ExternalReferenceDocument:        whereHelpernull_String{field: "`data_platform_orders_header_data`.`ExternalReferenceDocument`"},
	CertificateAuthorityChain:        whereHelpernull_String{field: "`data_platform_orders_header_data`.`CertificateAuthorityChain`"},
	UsageControlChain:                whereHelpernull_String{field: "`data_platform_orders_header_data`.`UsageControlChain`"},
...
var DataPlatformOrdersHeaderDatumRels = struct {
	...
	OrderIDDataPlatformOrdersAddressData                      string
	OrderIDDataPlatformOrdersHeaderDocData                    string
	OrderIDDataPlatformOrdersItemData                         string
	OrderIDDataPlatformOrdersPartnerData                      string
	...
	OrderIDDataPlatformOrdersAddressData:                      "OrderIDDataPlatformOrdersAddressData",
	OrderIDDataPlatformOrdersHeaderDocData:                    "OrderIDDataPlatformOrdersHeaderDocData",
	OrderIDDataPlatformOrdersItemData:                         "OrderIDDataPlatformOrdersItemData",
	OrderIDDataPlatformOrdersPartnerData:                      "OrderIDDataPlatformOrdersPartnerData",
...
type dataPlatformOrdersHeaderDatumR struct {
	...
	OrderIDDataPlatformOrdersAddressData                      DataPlatformOrdersAddressDatumSlice             `boil:"OrderIDDataPlatformOrdersAddressData" json:"OrderIDDataPlatformOrdersAddressData" toml:"OrderIDDataPlatformOrdersAddressData" yaml:"OrderIDDataPlatformOrdersAddressData"`
	OrderIDDataPlatformOrdersHeaderDocData                    DataPlatformOrdersHeaderDocDatumSlice           `boil:"OrderIDDataPlatformOrdersHeaderDocData" json:"OrderIDDataPlatformOrdersHeaderDocData" toml:"OrderIDDataPlatformOrdersHeaderDocData" yaml:"OrderIDDataPlatformOrdersHeaderDocData"`
	...
	OrderIDDataPlatformOrdersPartnerData                      DataPlatformOrdersPartnerDatumSlice             `boil:"OrderIDDataPlatformOrdersPartnerData" json:"OrderIDDataPlatformOrdersPartnerData" toml:"OrderIDDataPlatformOrdersPartnerData" yaml:"OrderIDDataPlatformOrdersPartnerData"`
...
func (r *dataPlatformOrdersHeaderDatumR) GetContractDataPlatformContractItemDatum() *DataPlatformContractItemDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformOrdersHeaderDatumR) GetContractDataPlatformContractHeaderDatum() *DataPlatformContractHeaderDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformOrdersHeaderDatumR) GetOperationIDDataPlatformProductionOrderItemOperationDatum() *DataPlatformProductionOrderItemOperationDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformOrdersHeaderDatumR) GetProductionOrderDataPlatformProductionOrderItemDatum() *DataPlatformProductionOrderItemDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformOrdersHeaderDatumR) GetProductionVersionDataPlatformProductionVersionItemDatum() *DataPlatformProductionVersionItemDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformOrdersHeaderDatumR) GetOrderIDDataPlatformOrdersAddressData() DataPlatformOrdersAddressDatumSlice {
	if r == nil {
		return nil
	}
	return r.OrderIDDataPlatformOrdersAddressData
}

func (r *dataPlatformOrdersHeaderDatumR) GetOrderIDDataPlatformOrdersHeaderDocData() DataPlatformOrdersHeaderDocDatumSlice {
	if r == nil {
		return nil
	}
	return r.OrderIDDataPlatformOrdersHeaderDocData
}
...
func (r *dataPlatformOrdersHeaderDatumR) GetOrderIDDataPlatformOrdersPartnerData() DataPlatformOrdersPartnerDatumSlice {
	if r == nil {
		return nil
	}
	return r.OrderIDDataPlatformOrdersPartnerData
}
...
func (o *DataPlatformOrdersHeaderDatum) ContractDataPlatformContractItemDatum(mods ...qm.QueryMod) dataPlatformContractItemDatumQuery {
	queryMods := []qm.QueryMod{
...
func (o *DataPlatformOrdersHeaderDatum) ContractDataPlatformContractHeaderDatum(mods ...qm.QueryMod) dataPlatformContractHeaderDatumQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`Contract` = ?", o.Contract),
	}
...
func (o *DataPlatformOrdersHeaderDatum) OperationIDDataPlatformProductionOrderItemOperationDatum(mods ...qm.QueryMod) dataPlatformProductionOrderItemOperationDatumQuery {
	queryMods := []qm.QueryMod{
...
func (o *DataPlatformOrdersHeaderDatum) ProductionOrderDataPlatformProductionOrderItemDatum(mods ...qm.QueryMod) dataPlatformProductionOrderItemDatumQuery {
	queryMods := []qm.QueryMod{
...
func (o *DataPlatformOrdersHeaderDatum) ProductionVersionDataPlatformProductionVersionItemDatum(mods ...qm.QueryMod) dataPlatformProductionVersionItemDatumQuery {
	queryMods := []qm.QueryMod{
...
// OrderIDDataPlatformOrdersAddressData retrieves all the data_platform_orders_address_datum's DataPlatformOrdersAddressData with an executor via OrderID column.
func (o *DataPlatformOrdersHeaderDatum) OrderIDDataPlatformOrdersAddressData(mods ...qm.QueryMod) dataPlatformOrdersAddressDatumQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`data_platform_orders_address_data`.`OrderID`=?", o.OrderID),
	)

	return DataPlatformOrdersAddressData(queryMods...)
}

// OrderIDDataPlatformOrdersHeaderDocData retrieves all the data_platform_orders_header_doc_datum's DataPlatformOrdersHeaderDocData with an executor via OrderID column.
func (o *DataPlatformOrdersHeaderDatum) OrderIDDataPlatformOrdersHeaderDocData(mods ...qm.QueryMod) dataPlatformOrdersHeaderDocDatumQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`data_platform_orders_header_doc_data`.`OrderID`=?", o.OrderID),
	)
...
// OrderIDDataPlatformOrdersPartnerData retrieves all the data_platform_orders_partner_datum's DataPlatformOrdersPartnerData with an executor via OrderID column.
func (o *DataPlatformOrdersHeaderDatum) OrderIDDataPlatformOrdersPartnerData(mods ...qm.QueryMod) dataPlatformOrdersPartnerDatumQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`data_platform_orders_partner_data`.`OrderID`=?", o.OrderID),
	)
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOrdersHeaderDatumL) LoadContractDataPlatformContractItemDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOrdersHeaderDatumL) LoadContractDataPlatformContractHeaderDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOrdersHeaderDatumL) LoadOperationIDDataPlatformProductionOrderItemOperationDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOrdersHeaderDatumL) LoadProductionOrderDataPlatformProductionOrderItemDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOrdersHeaderDatumL) LoadProductionVersionDataPlatformProductionVersionItemDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
...
// LoadOrderIDDataPlatformOrdersAddressData allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (dataPlatformOrdersHeaderDatumL) LoadOrderIDDataPlatformOrdersAddressData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
	...
	query := NewQuery(
		...
		qm.WhereIn(`data_platform_orders_address_data.OrderID in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.OrderIDDataPlatformOrdersAddressData = resultSlice
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.OrderID == foreign.OrderID {
				local.R.OrderIDDataPlatformOrdersAddressData = append(local.R.OrderIDDataPlatformOrdersAddressData, foreign)
				break
			}
		}
	}
...
// LoadOrderIDDataPlatformOrdersHeaderDocData allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (dataPlatformOrdersHeaderDatumL) LoadOrderIDDataPlatformOrdersHeaderDocData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
	...
	query := NewQuery(
		...
		qm.WhereIn(`data_platform_orders_header_doc_data.OrderID in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.OrderIDDataPlatformOrdersHeaderDocData = resultSlice
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.OrderID == foreign.OrderID {
				local.R.OrderIDDataPlatformOrdersHeaderDocData = append(local.R.OrderIDDataPlatformOrdersHeaderDocData, foreign)
				break
			}
		}
	}
...
// LoadOrderIDDataPlatformOrdersPartnerData allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (dataPlatformOrdersHeaderDatumL) LoadOrderIDDataPlatformOrdersPartnerData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOrdersHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOrdersHeaderDatum
	var object *DataPlatformOrdersHeaderDatum
	...
	query := NewQuery(
		...
		qm.WhereIn(`data_platform_orders_partner_data.OrderID in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.OrderIDDataPlatformOrdersPartnerData = resultSlice
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.OrderID == foreign.OrderID {
				local.R.OrderIDDataPlatformOrdersPartnerData = append(local.R.OrderIDDataPlatformOrdersPartnerData, foreign)
				break
			}
		}
	}
...
// SetContractDataPlatformContractItemDatum of the dataPlatformOrdersHeaderDatum to the related item.
// Sets o.R.ContractDataPlatformContractItemDatum to related.
func (o *DataPlatformOrdersHeaderDatum) SetContractDataPlatformContractItemDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformContractItemDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.Contract, o.OrderID}
...
func (o *DataPlatformOrdersHeaderDatum) RemoveContractDataPlatformContractItemDatum(ctx context.Context, exec boil.ContextExecutor, related *DataPlatformContractItemDatum) error {
	var err error
...
// SetContractDataPlatformContractHeaderDatum of the dataPlatformOrdersHeaderDatum to the related item.
// Sets o.R.ContractDataPlatformContractHeaderDatum to related.
func (o *DataPlatformOrdersHeaderDatum) SetContractDataPlatformContractHeaderDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformContractHeaderDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func (o *DataPlatformOrdersHeaderDatum) RemoveContractDataPlatformContractHeaderDatum(ctx context.Context, exec boil.ContextExecutor, related *DataPlatformContractHeaderDatum) error {
	var err error
...
// SetOperationIDDataPlatformProductionOrderItemOperationDatum of the dataPlatformOrdersHeaderDatum to the related item.
// Sets o.R.OperationIDDataPlatformProductionOrderItemOperationDatum to related.
func (o *DataPlatformOrdersHeaderDatum) SetOperationIDDataPlatformProductionOrderItemOperationDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformProductionOrderItemOperationDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.OperationID, o.OrderID}
...
func (o *DataPlatformOrdersHeaderDatum) RemoveOperationIDDataPlatformProductionOrderItemOperationDatum(ctx context.Context, exec boil.ContextExecutor, related *DataPlatformProductionOrderItemOperationDatum) error {
	var err error
...
// SetProductionOrderDataPlatformProductionOrderItemDatum of the dataPlatformOrdersHeaderDatum to the related item.
// Sets o.R.ProductionOrderDataPlatformProductionOrderItemDatum to related.
func (o *DataPlatformOrdersHeaderDatum) SetProductionOrderDataPlatformProductionOrderItemDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformProductionOrderItemDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.ProductionOrder, o.OrderID}
...
func (o *DataPlatformOrdersHeaderDatum) RemoveProductionOrderDataPlatformProductionOrderItemDatum(ctx context.Context, exec boil.ContextExecutor, related *DataPlatformProductionOrderItemDatum) error {
	var err error
...
// SetProductionVersionDataPlatformProductionVersionItemDatum of the dataPlatformOrdersHeaderDatum to the related item.
// Sets o.R.ProductionVersionDataPlatformProductionVersionItemDatum to related.
func (o *DataPlatformOrdersHeaderDatum) SetProductionVersionDataPlatformProductionVersionItemDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformProductionVersionItemDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.ProductionVersion, o.OrderID}
...
func (o *DataPlatformOrdersHeaderDatum) RemoveProductionVersionDataPlatformProductionVersionItemDatum(ctx context.Context, exec boil.ContextExecutor, related *DataPlatformProductionVersionItemDatum) error {
	var err error
...
// AddOrderIDDataPlatformOrdersAddressData adds the given related objects to the existing relationships
// of the data_platform_orders_header_datum, optionally inserting them as new records.
// Appends related to o.R.OrderIDDataPlatformOrdersAddressData.
func (o *DataPlatformOrdersHeaderDatum) AddOrderIDDataPlatformOrdersAddressData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformOrdersAddressDatum) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.OrderID, rel.OrderID, rel.AddressID}
	...
	if o.R == nil {
		o.R = &dataPlatformOrdersHeaderDatumR{
			OrderIDDataPlatformOrdersAddressData: related,
		}
	} else {
		o.R.OrderIDDataPlatformOrdersAddressData = append(o.R.OrderIDDataPlatformOrdersAddressData, related...)
	}

	return nil
}

// AddOrderIDDataPlatformOrdersHeaderDocData adds the given related objects to the existing relationships
// of the data_platform_orders_header_datum, optionally inserting them as new records.
// Appends related to o.R.OrderIDDataPlatformOrdersHeaderDocData.
func (o *DataPlatformOrdersHeaderDatum) AddOrderIDDataPlatformOrdersHeaderDocData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformOrdersHeaderDocDatum) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.OrderID = o.OrderID
			...
			values := []interface{}{o.OrderID, rel.OrderID, rel.DocType, rel.DocVersionID, rel.DocID}
	...
	if o.R == nil {
		o.R = &dataPlatformOrdersHeaderDatumR{
			OrderIDDataPlatformOrdersHeaderDocData: related,
		}
	} else {
		o.R.OrderIDDataPlatformOrdersHeaderDocData = append(o.R.OrderIDDataPlatformOrdersHeaderDocData, related...)
	}
...
// AddOrderIDDataPlatformOrdersPartnerData adds the given related objects to the existing relationships
// of the data_platform_orders_header_datum, optionally inserting them as new records.
// Appends related to o.R.OrderIDDataPlatformOrdersPartnerData.
func (o *DataPlatformOrdersHeaderDatum) AddOrderIDDataPlatformOrdersPartnerData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformOrdersPartnerDatum) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.OrderID = o.OrderID
	...
	if o.R == nil {
		o.R = &dataPlatformOrdersHeaderDatumR{
			OrderIDDataPlatformOrdersPartnerData: related,
		}
	} else {
		o.R.OrderIDDataPlatformOrdersPartnerData = append(o.R.OrderIDDataPlatformOrdersPartnerData, related...)
	}
