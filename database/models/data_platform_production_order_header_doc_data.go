...
func (r *dataPlatformProductionOrderHeaderDocDatumR) GetDocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum() *DataPlatformBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformProductionOrderHeaderDocDatumR) GetDocTypeDataPlatformDocTypeDocTypeDatum() *DataPlatformDocTypeDocTypeDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformProductionOrderHeaderDocDatumR) GetProductionOrderDataPlatformProductionOrderHeaderDatum() *DataPlatformProductionOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func (o *DataPlatformProductionOrderHeaderDocDatum) DocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum(mods ...qm.QueryMod) dataPlatformBusinessPartnerGeneralDatumQuery {
...
func (o *DataPlatformProductionOrderHeaderDocDatum) DocTypeDataPlatformDocTypeDocTypeDatum(mods ...qm.QueryMod) dataPlatformDocTypeDocTypeDatumQuery {
	queryMods := []qm.QueryMod{
...
func (o *DataPlatformProductionOrderHeaderDocDatum) ProductionOrderDataPlatformProductionOrderHeaderDatum(mods ...qm.QueryMod) dataPlatformProductionOrderHeaderDatumQuery {
	queryMods := []qm.QueryMod{
...
func (dataPlatformProductionOrderHeaderDocDatumL) LoadDocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionOrderHeaderDocDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionOrderHeaderDocDatum
	var object *DataPlatformProductionOrderHeaderDocDatum

	if singular {
		var ok bool
		object, ok = maybeDataPlatformProductionOrderHeaderDocDatum.(*DataPlatformProductionOrderHeaderDocDatum)
		if !ok {
			object = new(DataPlatformProductionOrderHeaderDocDatum)
			ok = queries.SetFromEmbeddedStruct(&object, &maybeDataPlatformProductionOrderHeaderDocDatum)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", object, maybeDataPlatformProductionOrderHeaderDocDatum))
			}
		}
	} else {
		s, ok := maybeDataPlatformProductionOrderHeaderDocDatum.(*[]*DataPlatformProductionOrderHeaderDocDatum)
		if ok {
			slice = *s
		} else {
			ok = queries.SetFromEmbeddedStruct(&slice, maybeDataPlatformProductionOrderHeaderDocDatum)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", slice, maybeDataPlatformProductionOrderHeaderDocDatum))
			}
		}
	}
	...
	if singular {
		if object.R == nil {
			object.R = &dataPlatformProductionOrderHeaderDocDatumR{}
		}
	...
	Outer:
		for _, obj := range slice {
			if obj.R == nil {
				obj.R = &dataPlatformProductionOrderHeaderDocDatumR{}
			}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformProductionOrderHeaderDocDatumL) LoadDocTypeDataPlatformDocTypeDocTypeDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionOrderHeaderDocDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionOrderHeaderDocDatum
	var object *DataPlatformProductionOrderHeaderDocDatum
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformProductionOrderHeaderDocDatumL) LoadProductionOrderDataPlatformProductionOrderHeaderDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionOrderHeaderDocDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionOrderHeaderDocDatum
	var object *DataPlatformProductionOrderHeaderDocDatum
...
// SetDocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum of the dataPlatformProductionOrderHeaderDocDatum to the related item.
// Sets o.R.DocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum to related.
func (o *DataPlatformProductionOrderHeaderDocDatum) SetDocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformBusinessPartnerGeneralDatum) error {
	var err error
	if insert {
	...
	values := []interface{}{related.BusinessPartner, o.ProductionOrder, o.DocType, o.DocVersionID, o.DocID}
	...
	if o.R == nil {
		o.R = &dataPlatformProductionOrderHeaderDocDatumR{
...
func (o *DataPlatformProductionOrderHeaderDocDatum) RemoveDocIssuerBusinessPartnerDataPlatformBusinessPartnerGeneralDatum(ctx context.Context, exec boil.ContextExecutor, related *DataPlatformBusinessPartnerGeneralDatum) error {
	var err error
...
// SetDocTypeDataPlatformDocTypeDocTypeDatum of the dataPlatformProductionOrderHeaderDocDatum to the related item.
// Sets o.R.DocTypeDataPlatformDocTypeDocTypeDatum to related.
func (o *DataPlatformProductionOrderHeaderDocDatum) SetDocTypeDataPlatformDocTypeDocTypeDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformDocTypeDocTypeDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.DocType, o.ProductionOrder, o.DocType, o.DocVersionID, o.DocID}
...
// SetProductionOrderDataPlatformProductionOrderHeaderDatum of the dataPlatformProductionOrderHeaderDocDatum to the related item.
// Sets o.R.ProductionOrderDataPlatformProductionOrderHeaderDatum to related.
func (o *DataPlatformProductionOrderHeaderDocDatum) SetProductionOrderDataPlatformProductionOrderHeaderDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformProductionOrderHeaderDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.ProductionOrder, o.ProductionOrder, o.DocType, o.DocVersionID, o.DocID}
