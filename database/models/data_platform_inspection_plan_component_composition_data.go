...
var DataPlatformInspectionPlanComponentCompositionDatumTableColumns = struct {
	...
	ComponentCompositionUpperLimitInPercent:    "data_platform_inspection_plan_component_composition_data.ComponentCompositionUpperLimitInPercent",
	ComponentCompositionLowerLimitInPercent:    "data_platform_inspection_plan_component_composition_data.ComponentCompositionLowerLimitInPercent",
	ComponentCompositionStandardValueInPercent: "data_platform_inspection_plan_component_composition_data.ComponentCompositionStandardValueInPercent",
...
var DataPlatformInspectionPlanComponentCompositionDatumWhere = struct {
	...
	ComponentCompositionUpperLimitInPercent:    whereHelperfloat32{field: "`data_platform_inspection_plan_component_composition_data`.`ComponentCompositionUpperLimitInPercent`"},
	ComponentCompositionLowerLimitInPercent:    whereHelperfloat32{field: "`data_platform_inspection_plan_component_composition_data`.`ComponentCompositionLowerLimitInPercent`"},
	ComponentCompositionStandardValueInPercent: whereHelperfloat32{field: "`data_platform_inspection_plan_component_composition_data`.`ComponentCompositionStandardValueInPercent`"},
	CreationDate:                               whereHelperstring{field: "`data_platform_inspection_plan_component_composition_data`.`CreationDate`"},
	LastChangeDate:                             whereHelperstring{field: "`data_platform_inspection_plan_component_composition_data`.`LastChangeDate`"},
...
var (
	dataPlatformInspectionPlanComponentCompositionDatumAllColumns            = []string{"InspectionPlan", "ComponentCompositionType", "ComponentCompositionUpperLimitInPercent", "ComponentCompositionLowerLimitInPercent", "ComponentCompositionStandardValueInPercent", "CreationDate", "LastChangeDate", "IsMarkedForDeletion"}
	dataPlatformInspectionPlanComponentCompositionDatumColumnsWithoutDefault = []string{"InspectionPlan", "ComponentCompositionType", "ComponentCompositionUpperLimitInPercent", "ComponentCompositionLowerLimitInPercent", "ComponentCompositionStandardValueInPercent", "CreationDate", "LastChangeDate", "IsMarkedForDeletion"}
	dataPlatformInspectionPlanComponentCompositionDatumColumnsWithDefault    = []string{}
	dataPlatformInspectionPlanComponentCompositionDatumPrimaryKeyColumns     = []string{"InspectionPlan", "ComponentCompositionType"}
...
func (o *DataPlatformInspectionPlanComponentCompositionDatum) SetInspectionPlanDataPlatformInspectionPlanHeaderDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformInspectionPlanHeaderDatum) error {
	...
	values := []interface{}{related.InspectionPlan, o.InspectionPlan, o.ComponentCompositionType}
...
func FindDataPlatformInspectionPlanComponentCompositionDatum(ctx context.Context, exec boil.ContextExecutor, inspectionPlan int, componentCompositionType string, selectCols ...string) (*DataPlatformInspectionPlanComponentCompositionDatum, error) {
	...
	query := fmt.Sprintf(
		"select %s from `data_platform_inspection_plan_component_composition_data` where `InspectionPlan`=? AND `ComponentCompositionType`=?", sel,
	)

	q := queries.Raw(query, inspectionPlan, componentCompositionType)
...
func (o *DataPlatformInspectionPlanComponentCompositionDatum) Delete(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "DELETE FROM `data_platform_inspection_plan_component_composition_data` WHERE `InspectionPlan`=? AND `ComponentCompositionType`=?"
...
func (o *DataPlatformInspectionPlanComponentCompositionDatum) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindDataPlatformInspectionPlanComponentCompositionDatum(ctx, exec, o.InspectionPlan, o.ComponentCompositionType)
	if err != nil {
		return err
	}
...
func DataPlatformInspectionPlanComponentCompositionDatumExists(ctx context.Context, exec boil.ContextExecutor, inspectionPlan int, componentCompositionType string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `data_platform_inspection_plan_component_composition_data` where `InspectionPlan`=? AND `ComponentCompositionType`=? limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, inspectionPlan, componentCompositionType)
	}
	row := exec.QueryRowContext(ctx, sql, inspectionPlan, componentCompositionType)
...
func (o *DataPlatformInspectionPlanComponentCompositionDatum) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return DataPlatformInspectionPlanComponentCompositionDatumExists(ctx, exec, o.InspectionPlan, o.ComponentCompositionType)
}
