...
var DataPlatformProductionOrderItemComponentCostingDatumTableColumns = struct {
	...
	CreationDate:        "data_platform_production_order_item_component_costing_data.CreationDate",
	CreationTime:        "data_platform_production_order_item_component_costing_data.CreationTime",
	LastChangeDate:      "data_platform_production_order_item_component_costing_data.LastChangeDate",
	LastChangeTime:      "data_platform_production_order_item_component_costing_data.LastChangeTime",
	IsReleased:          "data_platform_production_order_item_component_costing_data.IsReleased",
	IsLocked:            "data_platform_production_order_item_component_costing_data.IsLocked",
	IsCancelled:         "data_platform_production_order_item_component_costing_data.IsCancelled",
...
var DataPlatformProductionOrderItemComponentCostingDatumWhere = struct {
	...
	Currency:            whereHelperstring{field: "`data_platform_production_order_item_component_costing_data`.`Currency`"},
	CostingAmount:       whereHelperfloat32{field: "`data_platform_production_order_item_component_costing_data`.`CostingAmount`"},
	CreationDate:        whereHelperstring{field: "`data_platform_production_order_item_component_costing_data`.`CreationDate`"},
	CreationTime:        whereHelperstring{field: "`data_platform_production_order_item_component_costing_data`.`CreationTime`"},
	LastChangeDate:      whereHelperstring{field: "`data_platform_production_order_item_component_costing_data`.`LastChangeDate`"},
	LastChangeTime:      whereHelperstring{field: "`data_platform_production_order_item_component_costing_data`.`LastChangeTime`"},
	IsReleased:          whereHelpernull_Bool{field: "`data_platform_production_order_item_component_costing_data`.`IsReleased`"},
	IsLocked:            whereHelpernull_Bool{field: "`data_platform_production_order_item_component_costing_data`.`IsLocked`"},
	IsCancelled:         whereHelpernull_Bool{field: "`data_platform_production_order_item_component_costing_data`.`IsCancelled`"},
...
func (r *dataPlatformProductionOrderItemComponentCostingDatumR) GetCurrencyDataPlatformCurrencyCurrencyDatum() *DataPlatformCurrencyCurrencyDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformProductionOrderItemComponentCostingDatumR) GetBillOfMaterialDataPlatformProductionOrderItemComponentDatum() *DataPlatformProductionOrderItemComponentDatum {
	if r == nil {
		return nil
	}
...
var (
	dataPlatformProductionOrderItemComponentCostingDatumAllColumns            = []string{"ProductionOrder", "ProductionOrderItem", "BillOfMaterial", "BillOfMaterialItem", "Currency", "CostingAmount", "CreationDate", "CreationTime", "LastChangeDate", "LastChangeTime", "IsReleased", "IsLocked", "IsCancelled", "IsMarkedForDeletion"}
	dataPlatformProductionOrderItemComponentCostingDatumColumnsWithoutDefault = []string{"ProductionOrder", "ProductionOrderItem", "BillOfMaterial", "BillOfMaterialItem", "Currency", "CostingAmount", "CreationDate", "CreationTime", "LastChangeDate", "LastChangeTime", "IsReleased", "IsLocked", "IsCancelled", "IsMarkedForDeletion"}
	dataPlatformProductionOrderItemComponentCostingDatumColumnsWithDefault    = []string{}
	dataPlatformProductionOrderItemComponentCostingDatumPrimaryKeyColumns     = []string{"ProductionOrder", "ProductionOrderItem", "BillOfMaterial", "BillOfMaterialItem"}
...
func (o *DataPlatformProductionOrderItemComponentCostingDatum) CurrencyDataPlatformCurrencyCurrencyDatum(mods ...qm.QueryMod) dataPlatformCurrencyCurrencyDatumQuery {
...
func (o *DataPlatformProductionOrderItemComponentCostingDatum) BillOfMaterialDataPlatformProductionOrderItemComponentDatum(mods ...qm.QueryMod) dataPlatformProductionOrderItemComponentDatumQuery {
	queryMods := []qm.QueryMod{
...
func (dataPlatformProductionOrderItemComponentCostingDatumL) LoadCurrencyDataPlatformCurrencyCurrencyDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionOrderItemComponentCostingDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionOrderItemComponentCostingDatum
	var object *DataPlatformProductionOrderItemComponentCostingDatum

	if singular {
		var ok bool
		object, ok = maybeDataPlatformProductionOrderItemComponentCostingDatum.(*DataPlatformProductionOrderItemComponentCostingDatum)
		if !ok {
			object = new(DataPlatformProductionOrderItemComponentCostingDatum)
			ok = queries.SetFromEmbeddedStruct(&object, &maybeDataPlatformProductionOrderItemComponentCostingDatum)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", object, maybeDataPlatformProductionOrderItemComponentCostingDatum))
			}
		}
	} else {
		s, ok := maybeDataPlatformProductionOrderItemComponentCostingDatum.(*[]*DataPlatformProductionOrderItemComponentCostingDatum)
		if ok {
			slice = *s
		} else {
			ok = queries.SetFromEmbeddedStruct(&slice, maybeDataPlatformProductionOrderItemComponentCostingDatum)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", slice, maybeDataPlatformProductionOrderItemComponentCostingDatum))
			}
		}
	}
	...
	if singular {
		if object.R == nil {
			object.R = &dataPlatformProductionOrderItemComponentCostingDatumR{}
		}
	...
	Outer:
		for _, obj := range slice {
			if obj.R == nil {
				obj.R = &dataPlatformProductionOrderItemComponentCostingDatumR{}
			}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformProductionOrderItemComponentCostingDatumL) LoadBillOfMaterialDataPlatformProductionOrderItemComponentDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionOrderItemComponentCostingDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionOrderItemComponentCostingDatum
	var object *DataPlatformProductionOrderItemComponentCostingDatum
...
// SetCurrencyDataPlatformCurrencyCurrencyDatum of the dataPlatformProductionOrderItemComponentCostingDatum to the related item.
// Sets o.R.CurrencyDataPlatformCurrencyCurrencyDatum to related.
func (o *DataPlatformProductionOrderItemComponentCostingDatum) SetCurrencyDataPlatformCurrencyCurrencyDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformCurrencyCurrencyDatum) error {
	var err error
	if insert {
	...
	values := []interface{}{related.Currency, o.ProductionOrder, o.ProductionOrderItem, o.BillOfMaterial, o.BillOfMaterialItem}
	...
	if o.R == nil {
		o.R = &dataPlatformProductionOrderItemComponentCostingDatumR{
...
// SetBillOfMaterialDataPlatformProductionOrderItemComponentDatum of the dataPlatformProductionOrderItemComponentCostingDatum to the related item.
// Sets o.R.BillOfMaterialDataPlatformProductionOrderItemComponentDatum to related.
func (o *DataPlatformProductionOrderItemComponentCostingDatum) SetBillOfMaterialDataPlatformProductionOrderItemComponentDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformProductionOrderItemComponentDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func FindDataPlatformProductionOrderItemComponentCostingDatum(ctx context.Context, exec boil.ContextExecutor, productionOrder int, productionOrderItem int, billOfMaterial int, billOfMaterialItem int, selectCols ...string) (*DataPlatformProductionOrderItemComponentCostingDatum, error) {
	...
	query := fmt.Sprintf(
		"select %s from `data_platform_production_order_item_component_costing_data` where `ProductionOrder`=? AND `ProductionOrderItem`=? AND `BillOfMaterial`=? AND `BillOfMaterialItem`=?", sel,
	)
...
func (o *DataPlatformProductionOrderItemComponentCostingDatum) Delete(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "DELETE FROM `data_platform_production_order_item_component_costing_data` WHERE `ProductionOrder`=? AND `ProductionOrderItem`=? AND `BillOfMaterial`=? AND `BillOfMaterialItem`=?"
...
func (o *DataPlatformProductionOrderItemComponentCostingDatum) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindDataPlatformProductionOrderItemComponentCostingDatum(ctx, exec, o.ProductionOrder, o.ProductionOrderItem, o.BillOfMaterial, o.BillOfMaterialItem)
	if err != nil {
		return err
	}
...
func DataPlatformProductionOrderItemComponentCostingDatumExists(ctx context.Context, exec boil.ContextExecutor, productionOrder int, productionOrderItem int, billOfMaterial int, billOfMaterialItem int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `data_platform_production_order_item_component_costing_data` where `ProductionOrder`=? AND `ProductionOrderItem`=? AND `BillOfMaterial`=? AND `BillOfMaterialItem`=? limit 1)"
...
func (o *DataPlatformProductionOrderItemComponentCostingDatum) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return DataPlatformProductionOrderItemComponentCostingDatumExists(ctx, exec, o.ProductionOrder, o.ProductionOrderItem, o.BillOfMaterial, o.BillOfMaterialItem)
}
