...
var DataPlatformProductionVersionHeaderDatumRels = struct {
	...
	ProductionVersionDataPlatformPlannedOrderHeaderData       string
	...
	ProductionVersionDataPlatformPlannedOrderHeaderData:       "ProductionVersionDataPlatformPlannedOrderHeaderData",
...
type dataPlatformProductionVersionHeaderDatumR struct {
	...
	ProductionVersionDataPlatformPlannedOrderHeaderData       DataPlatformPlannedOrderHeaderDatumSlice    `boil:"ProductionVersionDataPlatformPlannedOrderHeaderData" json:"ProductionVersionDataPlatformPlannedOrderHeaderData" toml:"ProductionVersionDataPlatformPlannedOrderHeaderData" yaml:"ProductionVersionDataPlatformPlannedOrderHeaderData"`
...
func (r *dataPlatformProductionVersionHeaderDatumR) GetBillOfMaterialDataPlatformBillOfMaterialHeaderDatum() *DataPlatformBillOfMaterialHeaderDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformProductionVersionHeaderDatumR) GetOperation() *DataPlatformOperationsHeaderDatum {
	if r == nil {
		return nil
	}
	return r.Operation
...
func (r *dataPlatformProductionVersionHeaderDatumR) GetProductionVersionDataPlatformPlannedOrderHeaderData() DataPlatformPlannedOrderHeaderDatumSlice {
	if r == nil {
		return nil
	}
	return r.ProductionVersionDataPlatformPlannedOrderHeaderData
}
...
func (o *DataPlatformProductionVersionHeaderDatum) BillOfMaterialDataPlatformBillOfMaterialHeaderDatum(mods ...qm.QueryMod) dataPlatformBillOfMaterialHeaderDatumQuery {
...
func (o *DataPlatformProductionVersionHeaderDatum) Operation(mods ...qm.QueryMod) dataPlatformOperationsHeaderDatumQuery {
	queryMods := []qm.QueryMod{
...
// ProductionVersionDataPlatformPlannedOrderHeaderData retrieves all the data_platform_planned_order_header_datum's DataPlatformPlannedOrderHeaderData with an executor via ProductionVersion column.
func (o *DataPlatformProductionVersionHeaderDatum) ProductionVersionDataPlatformPlannedOrderHeaderData(mods ...qm.QueryMod) dataPlatformPlannedOrderHeaderDatumQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`data_platform_planned_order_header_data`.`ProductionVersion`=?", o.ProductionVersion),
	)
...
func (dataPlatformProductionVersionHeaderDatumL) LoadBillOfMaterialDataPlatformBillOfMaterialHeaderDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionVersionHeaderDatum interface{}, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformProductionVersionHeaderDatumL) LoadOperation(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionVersionHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionVersionHeaderDatum
	var object *DataPlatformProductionVersionHeaderDatum
...
// LoadProductionVersionDataPlatformPlannedOrderHeaderData allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (dataPlatformProductionVersionHeaderDatumL) LoadProductionVersionDataPlatformPlannedOrderHeaderData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformProductionVersionHeaderDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformProductionVersionHeaderDatum
	var object *DataPlatformProductionVersionHeaderDatum
	...
	query := NewQuery(
		...
		qm.WhereIn(`data_platform_planned_order_header_data.ProductionVersion in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ProductionVersionDataPlatformPlannedOrderHeaderData = resultSlice
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ProductionVersion, foreign.ProductionVersion) {
				local.R.ProductionVersionDataPlatformPlannedOrderHeaderData = append(local.R.ProductionVersionDataPlatformPlannedOrderHeaderData, foreign)
				break
			}
		}
	}
...
// SetBillOfMaterialDataPlatformBillOfMaterialHeaderDatum of the dataPlatformProductionVersionHeaderDatum to the related item.
// Sets o.R.BillOfMaterialDataPlatformBillOfMaterialHeaderDatum to related.
func (o *DataPlatformProductionVersionHeaderDatum) SetBillOfMaterialDataPlatformBillOfMaterialHeaderDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformBillOfMaterialHeaderDatum) error {
	var err error
	if insert {
	...
	values := []interface{}{related.BillOfMaterial, o.ProductionVersion}
...
// SetOperation of the dataPlatformProductionVersionHeaderDatum to the related item.
// Sets o.R.Operation to related.
func (o *DataPlatformProductionVersionHeaderDatum) SetOperation(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformOperationsHeaderDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.Operations, o.ProductionVersion}
...
// AddProductionVersionDataPlatformPlannedOrderHeaderData adds the given related objects to the existing relationships
// of the data_platform_production_version_header_datum, optionally inserting them as new records.
// Appends related to o.R.ProductionVersionDataPlatformPlannedOrderHeaderData.
func (o *DataPlatformProductionVersionHeaderDatum) AddProductionVersionDataPlatformPlannedOrderHeaderData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformPlannedOrderHeaderDatum) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ProductionVersion, rel.PlannedOrder}
	...
	if o.R == nil {
		o.R = &dataPlatformProductionVersionHeaderDatumR{
			ProductionVersionDataPlatformPlannedOrderHeaderData: related,
		}
	} else {
		o.R.ProductionVersionDataPlatformPlannedOrderHeaderData = append(o.R.ProductionVersionDataPlatformPlannedOrderHeaderData, related...)
	}

	return nil
}

// SetProductionVersionDataPlatformPlannedOrderHeaderData removes all previously related items of the
// data_platform_production_version_header_datum replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.ProductionVersionDataPlatformProductionVersionHeaderDatum's ProductionVersionDataPlatformPlannedOrderHeaderData accordingly.
// Replaces o.R.ProductionVersionDataPlatformPlannedOrderHeaderData with related.
func (o *DataPlatformProductionVersionHeaderDatum) SetProductionVersionDataPlatformPlannedOrderHeaderData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformPlannedOrderHeaderDatum) error {
	query := "update `data_platform_planned_order_header_data` set `ProductionVersion` = null where `ProductionVersion` = ?"
	...
	if o.R != nil {
		o.R.ProductionVersionDataPlatformPlannedOrderHeaderData = nil
	}

	return o.AddProductionVersionDataPlatformPlannedOrderHeaderData(ctx, exec, insert, related...)
}

// RemoveProductionVersionDataPlatformPlannedOrderHeaderData relationships from objects passed in.
// Removes related items from R.ProductionVersionDataPlatformPlannedOrderHeaderData (uses pointer comparison, removal does not keep order)
func (o *DataPlatformProductionVersionHeaderDatum) RemoveProductionVersionDataPlatformPlannedOrderHeaderData(ctx context.Context, exec boil.ContextExecutor, related ...*DataPlatformPlannedOrderHeaderDatum) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.ProductionVersionDataPlatformPlannedOrderHeaderData {
			if rel != ri {
				continue
			}

			ln := len(o.R.ProductionVersionDataPlatformPlannedOrderHeaderData)
			if ln > 1 && i < ln-1 {
				o.R.ProductionVersionDataPlatformPlannedOrderHeaderData[i] = o.R.ProductionVersionDataPlatformPlannedOrderHeaderData[ln-1]
			}
			o.R.ProductionVersionDataPlatformPlannedOrderHeaderData = o.R.ProductionVersionDataPlatformPlannedOrderHeaderData[:ln-1]
			break
		}
	}
