...
func (r *dataPlatformSCRBillingRelationDatumR) GetBillFromPartyDataPlatformContractHeaderData() DataPlatformContractHeaderDatumSlice {
	if r == nil {
		return nil
	}
...
func (o *DataPlatformSCRBillingRelationDatum) BillFromPartyDataPlatformContractHeaderData(mods ...qm.QueryMod) dataPlatformContractHeaderDatumQuery {
...
func (dataPlatformSCRBillingRelationDatumL) LoadBillFromPartyDataPlatformContractHeaderData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformSCRBillingRelationDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformSCRBillingRelationDatum
	var object *DataPlatformSCRBillingRelationDatum
...
func (o *DataPlatformSCRBillingRelationDatum) AddBillFromPartyDataPlatformContractHeaderData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformContractHeaderDatum) error {
	var err error
...
// Sets o.R.BillFromPartyDataPlatformSCRBillingRelationDatum's BillFromPartyDataPlatformContractHeaderData accordingly.
// Replaces o.R.BillFromPartyDataPlatformContractHeaderData with related.
func (o *DataPlatformSCRBillingRelationDatum) SetBillFromPartyDataPlatformContractHeaderData(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DataPlatformContractHeaderDatum) error {
...
func (o *DataPlatformSCRBillingRelationDatum) RemoveBillFromPartyDataPlatformContractHeaderData(ctx context.Context, exec boil.ContextExecutor, related ...*DataPlatformContractHeaderDatum) error {
	if len(related) == 0 {
		return nil
	}
