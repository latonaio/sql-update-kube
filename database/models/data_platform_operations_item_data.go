...
func (r *dataPlatformOperationsItemDatumR) GetBuyerDataPlatformSCRDeliveryRelationDatum() *DataPlatformSCRDeliveryRelationDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformOperationsItemDatumR) GetBuyerDataPlatformSCRGeneralDatum() *DataPlatformSCRGeneralDatum {
	if r == nil {
		return nil
	}
...
var (
	dataPlatformOperationsItemDatumAllColumns            = []string{"Operations", "OperationsItem", "SupplyChainRelationshipID", "SupplyChainRelationshipDeliveryID", "SupplyChainRelationshipDeliveryPlantID", "SupplyChainRelationshipProductionPlantID", "Product", "Buyer", "Seller", "DeliverToParty", "DeliverToPlant", "DeliverFromParty", "DeliverFromPlant", "ProductionPlantBusinessPartner", "ProductionPlant", "OperationsText", "BillOfMaterial", "OperationsStatus", "ResponsiblePlannerGroup", "OperationsUnit", "StandardLotSizeQuantity", "MinimumLotSizeQuantity", "MaximumLotSizeQuantity", "PlainLongText", "WorkCenter", "ValidityStartDate", "ValidityEndDate", "CreationDate", "LastChangeDate", "IsMarkedForDeletion"}
...
func (o *DataPlatformOperationsItemDatum) BuyerDataPlatformSCRDeliveryRelationDatum(mods ...qm.QueryMod) dataPlatformSCRDeliveryRelationDatumQuery {
	queryMods := []qm.QueryMod{
...
func (o *DataPlatformOperationsItemDatum) BuyerDataPlatformSCRGeneralDatum(mods ...qm.QueryMod) dataPlatformSCRGeneralDatumQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`Buyer` = ?", o.Buyer),
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOperationsItemDatumL) LoadBuyerDataPlatformSCRDeliveryRelationDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOperationsItemDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOperationsItemDatum
	var object *DataPlatformOperationsItemDatum
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformOperationsItemDatumL) LoadBuyerDataPlatformSCRGeneralDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformOperationsItemDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformOperationsItemDatum
	var object *DataPlatformOperationsItemDatum
...
// SetBuyerDataPlatformSCRDeliveryRelationDatum of the dataPlatformOperationsItemDatum to the related item.
// Sets o.R.BuyerDataPlatformSCRDeliveryRelationDatum to related.
func (o *DataPlatformOperationsItemDatum) SetBuyerDataPlatformSCRDeliveryRelationDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformSCRDeliveryRelationDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// SetBuyerDataPlatformSCRGeneralDatum of the dataPlatformOperationsItemDatum to the related item.
// Sets o.R.BuyerDataPlatformSCRGeneralDatum to related.
func (o *DataPlatformOperationsItemDatum) SetBuyerDataPlatformSCRGeneralDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformSCRGeneralDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
