...
var DataPlatformInvoiceDocumentItemPricingElementDatumTableColumns = struct {
	...
	SupplyChainRelationshipID:  "data_platform_invoice_document_item_pricing_element_data.SupplyChainRelationshipID",
	Buyer:                      "data_platform_invoice_document_item_pricing_element_data.Buyer",
	Seller:                     "data_platform_invoice_document_item_pricing_element_data.Seller",
	...
	ConditionRateValueUnit:     "data_platform_invoice_document_item_pricing_element_data.ConditionRateValueUnit",
	ConditionScaleQuantity:     "data_platform_invoice_document_item_pricing_element_data.ConditionScaleQuantity",
	...
	CreationDate:               "data_platform_invoice_document_item_pricing_element_data.CreationDate",
	CreationTime:               "data_platform_invoice_document_item_pricing_element_data.CreationTime",
	LastChangeDate:             "data_platform_invoice_document_item_pricing_element_data.LastChangeDate",
	LastChangeTime:             "data_platform_invoice_document_item_pricing_element_data.LastChangeTime",
	IsCancelled:                "data_platform_invoice_document_item_pricing_element_data.IsCancelled",
}
...
var DataPlatformInvoiceDocumentItemPricingElementDatumWhere = struct {
	...
	SupplyChainRelationshipID:  whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`SupplyChainRelationshipID`"},
	Buyer:                      whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`Buyer`"},
	Seller:                     whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`Seller`"},
	ConditionRecord:            whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionRecord`"},
	ConditionSequentialNumber:  whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionSequentialNumber`"},
	ConditionType:              whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionType`"},
	PricingDate:                whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`PricingDate`"},
	ConditionRateValue:         whereHelperfloat32{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionRateValue`"},
	ConditionRateValueUnit:     whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionRateValueUnit`"},
	ConditionScaleQuantity:     whereHelperint{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionScaleQuantity`"},
	ConditionCurrency:          whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionCurrency`"},
	ConditionQuantity:          whereHelperfloat32{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionQuantity`"},
	TaxCode:                    whereHelpernull_String{field: "`data_platform_invoice_document_item_pricing_element_data`.`TaxCode`"},
	ConditionAmount:            whereHelperfloat32{field: "`data_platform_invoice_document_item_pricing_element_data`.`ConditionAmount`"},
	TransactionCurrency:        whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`TransactionCurrency`"},
	...
	CreationDate:               whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`CreationDate`"},
	CreationTime:               whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`CreationTime`"},
	LastChangeDate:             whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`LastChangeDate`"},
	LastChangeTime:             whereHelperstring{field: "`data_platform_invoice_document_item_pricing_element_data`.`LastChangeTime`"},
	IsCancelled:                whereHelpernull_Bool{field: "`data_platform_invoice_document_item_pricing_element_data`.`IsCancelled`"},
}
...
func (r *dataPlatformInvoiceDocumentItemPricingElementDatumR) GetBuyerDataPlatformSCRGeneralDatum() *DataPlatformSCRGeneralDatum {
	if r == nil {
		return nil
	}
...
func (r *dataPlatformInvoiceDocumentItemPricingElementDatumR) GetInvoiceDocumentDataPlatformInvoiceDocumentItemDatum() *DataPlatformInvoiceDocumentItemDatum {
	if r == nil {
		return nil
	}
...
func (o *DataPlatformInvoiceDocumentItemPricingElementDatum) BuyerDataPlatformSCRGeneralDatum(mods ...qm.QueryMod) dataPlatformSCRGeneralDatumQuery {
...
func (o *DataPlatformInvoiceDocumentItemPricingElementDatum) InvoiceDocumentDataPlatformInvoiceDocumentItemDatum(mods ...qm.QueryMod) dataPlatformInvoiceDocumentItemDatumQuery {
	queryMods := []qm.QueryMod{
...
func (dataPlatformInvoiceDocumentItemPricingElementDatumL) LoadBuyerDataPlatformSCRGeneralDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformInvoiceDocumentItemPricingElementDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformInvoiceDocumentItemPricingElementDatum
	var object *DataPlatformInvoiceDocumentItemPricingElementDatum

	if singular {
		var ok bool
		object, ok = maybeDataPlatformInvoiceDocumentItemPricingElementDatum.(*DataPlatformInvoiceDocumentItemPricingElementDatum)
		if !ok {
			object = new(DataPlatformInvoiceDocumentItemPricingElementDatum)
			ok = queries.SetFromEmbeddedStruct(&object, &maybeDataPlatformInvoiceDocumentItemPricingElementDatum)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", object, maybeDataPlatformInvoiceDocumentItemPricingElementDatum))
			}
		}
	} else {
		s, ok := maybeDataPlatformInvoiceDocumentItemPricingElementDatum.(*[]*DataPlatformInvoiceDocumentItemPricingElementDatum)
		if ok {
			slice = *s
		} else {
			ok = queries.SetFromEmbeddedStruct(&slice, maybeDataPlatformInvoiceDocumentItemPricingElementDatum)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", slice, maybeDataPlatformInvoiceDocumentItemPricingElementDatum))
			}
		}
	}
	...
	if singular {
		if object.R == nil {
			object.R = &dataPlatformInvoiceDocumentItemPricingElementDatumR{}
		}
	...
	Outer:
		for _, obj := range slice {
			if obj.R == nil {
				obj.R = &dataPlatformInvoiceDocumentItemPricingElementDatumR{}
			}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (dataPlatformInvoiceDocumentItemPricingElementDatumL) LoadInvoiceDocumentDataPlatformInvoiceDocumentItemDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDataPlatformInvoiceDocumentItemPricingElementDatum interface{}, mods queries.Applicator) error {
	var slice []*DataPlatformInvoiceDocumentItemPricingElementDatum
	var object *DataPlatformInvoiceDocumentItemPricingElementDatum
...
// SetBuyerDataPlatformSCRGeneralDatum of the dataPlatformInvoiceDocumentItemPricingElementDatum to the related item.
// Sets o.R.BuyerDataPlatformSCRGeneralDatum to related.
func (o *DataPlatformInvoiceDocumentItemPricingElementDatum) SetBuyerDataPlatformSCRGeneralDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformSCRGeneralDatum) error {
	var err error
	if insert {
	...
	values := []interface{}{related.Buyer, o.InvoiceDocument, o.InvoiceDocumentItem, o.PricingProcedureCounter}
	...
	if o.R == nil {
		o.R = &dataPlatformInvoiceDocumentItemPricingElementDatumR{
...
// SetInvoiceDocumentDataPlatformInvoiceDocumentItemDatum of the dataPlatformInvoiceDocumentItemPricingElementDatum to the related item.
// Sets o.R.InvoiceDocumentDataPlatformInvoiceDocumentItemDatum to related.
func (o *DataPlatformInvoiceDocumentItemPricingElementDatum) SetInvoiceDocumentDataPlatformInvoiceDocumentItemDatum(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DataPlatformInvoiceDocumentItemDatum) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.InvoiceDocument, o.InvoiceDocument, o.InvoiceDocumentItem, o.PricingProcedureCounter}
